 ...
 * UniTN
 */
package it.webgraphical.db.factories.jdbc;

import it.webgraphical.db.daos.DAO;
import it.webgraphical.db.daos.jdbc.JDBCDAO;
import it.webgraphical.db.exceptions.DAOFactoryException;
import it.webgraphical.db.factories.DAOFactory;
